...
# print(__name__)
# print(__doc__)
# print(__file__) # does not work in jupyter console!
# print(globals())
...
#%% If we want to import functions from script and avoid unwanted output:

# Solution 1: Group all the executable lines in a sector and say