...
class Musician:
    ...
    # __init__ is class constructor. Each python class HAS to have a constructor.
    # if we do not insert it, python will insert an empty one automatically
    # in constructor we define fields elements of our clas have
    #
    ...
    @name.setter
    def name(self, name):
        self.__name = name if isinstance(name, str) else 'unknown' # here we would add authorisation step in if statement
...
print(george) # print string representation of the object
print(george.name) # print attribute name
print(george.is_band_member) # print attribute is_band_member
# print(george._Musician__name) # this is why python is not safe!
# print(george)
# print(george.immutable_property)
print(george.play('While My Guitar Gently Weeps', 'Thank you!','Thanks!',goodbye='Goodbye!'))
...
george = Musician('George Harrison')
print(george == Musician('George Harrison'))
